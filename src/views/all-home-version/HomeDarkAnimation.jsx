...
const HomeDarkAnimation = () => {
  ...
  return (
    <div className="home-light">
      ...
      <div className="beny_tm_about" id="about">
        <div className="container">
          <div className="beny_tm_title_holder">
            ...
            <h2>About Me</h2>
            <p>
              Skilled, fun-loving and self-driven developer. By self driven, I
              mean I usually tell my Uber driver to sit at the back so that I
      ...
      {/* SERVICES */}
      <div className="beny_tm_services" id="skills">
        <div className="container">
          <Skills />
          {/* <div className="beny_tm_title_holder">
            <span>Services</span>
      ...
      <div className="beny_tm_portfolio" id="portfolio">
        <div className="container">
          <div className="beny_tm_title_holder">
            <span>Portfolio</span>
            <h2>My Portfolio</h2>
            <p>Here are a few sample projects that I have worked on:</p>
          </div>
          {/* End beny_tm_title */}
          <Portfolio />
        </div>
        ...
        <div className="container">
          <div className="contact_inner">
            ...
            >
              <div className="beny_tm_title_holder">
                <span>Contact</span>
                <h2>Reach out to me. Don't be shy:</h2>
              </div>
